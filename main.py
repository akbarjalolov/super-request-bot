...
def setup():
    """Visit this URL once in browser to wire Gmail -> PubSub -> this server."""
    try:
        ...
        try:
            ...
            results.append("OK: Pub/Sub topic created")
        except Exception as e:
            if "AlreadyExists" in str(e):
                results.append("INFO: Pub/Sub topic already exists")
            else:
                raise
        ...
        results.append("OK: IAM policy set")
        ...
        try:
            ...
            results.append(f"OK: Push subscription created -> {webhook_url}")
        except Exception as e:
            if "AlreadyExists" in str(e):
                results.append("INFO: Push subscription already exists")
            else:
                raise
        ...
        results.append(f"OK: Gmail watch active. Expiry: {resp.get('expiration')}")
        results.append("DONE: Bot is ready!")

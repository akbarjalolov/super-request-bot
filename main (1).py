...
# Service account credentials — stored as JSON string in env var (never commit the file)
...
def get_gmail_service():
    ...
    Reads credentials from SERVICE_ACCOUNT_JSON env var (JSON string).
    Impersonates GMAIL_USER to read their inbox.
    """
